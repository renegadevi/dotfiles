...
if has('gui_running') || &t_Co == 88 || &t_Co == 256
  ...
  " Color definition --------------------------------------------------------{{{
  if &background ==# 'dark'
    let s:mono_1 = 'abb2bf' " light-grey
    let s:mono_2 = '828997' " light-grey 2
    let s:mono_3 = '5c6370' " grey
    let s:mono_4 = '5c6370' " grey
    let s:mono_5 = 'e06c75' " red-pink
    let s:mono_6 = 'c678dd' " purple
  ...
  call <sid>X('CursorLine',   '',              '2c323c',         'none')
  ...
  " Standard syntax highlight ing --------------------------------------------{{{
  call <sid>X('Comment',        s:mono_4,  '',          'italic')
  ...
  " Asciidoc highlight ing ---------------------------------------------------{{{
  call <sid>X('asciidocListingBlock',   s:mono_2,  '', '')
  " }}}

  " Cucumber highligh ting ---------------------------------------------------{{{
  ...
  " Python highlighting - ----------------------------------------------------{{{
  call <sid>X('pythonLambdaExpr',             s:mono_5,   '', '')
  call <sid>X('pythonSelf',                   s:mono_5,   '', '')
  call <sid>X('pythonOperator',               s:mono_6,   '', '')
  call <sid>X('pythonRepeat',                 s:hue_3,    '', '')      
  call <sid>X('pythonInclude',                s:hue_3,    '', '')
  " }}}
